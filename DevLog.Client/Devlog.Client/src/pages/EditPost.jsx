...
import { getPostById, updatePost } from "../features/posts/postSlice";
...
function EditPost() {
  ...
  const onSubmit = async (data, publish = false) => {
    try {
      ...
      const response = await dispatch(updatePost({ id, formData })).unWarp();
      const updatedPostId = response.id;
      toast.success("Post updated successfully");
      if (publish) {
        await dispatch(publishPost(updatedPostId));
      }
